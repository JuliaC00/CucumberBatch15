...
public class APIWorkflowSteps extends APIConstants {
    Response response;
    ...
    @Then("the status code for featuring an employee is {int}")
    public void the_status_code_for_featuring_an_employee_is(Integer int1) {
        //argument or value is coming from feature file
        response.prettyPrint();
        response.then().assertThat().statusCode(int1);
    }
    @Then("employee contains key {string} and  value {string}")
    public void employee_contains_key_and_value(String message, String value) {
...
/***********************************************************************************************************/
@Given("request is prepared to create an employee with dynamic data {string} , {string} , {string} , {string} , {string} , {string} , {string}")
public void request_is_prepared_to_create_an_employee_with_dynamic_data(String string, String string2, String string3, String string4, String string5, String string6, String string7) {
        request = given().header(APIConstants.HEADER_KEY_CONTENT_TYPE,
                        APIConstants.HEADER_VALUE_CONTENT_TYPE).
                header(APIConstants.HEADER_KEY_AUTHORIZATION,GenerateTokenSteps.token)
        .body(APIPayloadConstants.createEmployeePayloadDynamic(string,string2,string3,string4,string5,string6,string7));
        }
/***************************************************************************************************************************************************************/
