...
public class AddEmployee extends CommonMethods {
    ...
    public void user_clicks_on_save_button() {
        ...
        System.out.println("My assertion returning true");
    ...
    public void query_the_information_in_backend() {
        String query="select *from hs_hr_employees_id='"+GlobalVariables.emp_id;
    ...
    public void verify_the_results_from_frontend_and_backend() {
        //from all these vlues we need to compare oe by one value
        ...
        System.out.println("My assertion has passed the test");
    }
